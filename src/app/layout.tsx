...
export const metadata: Metadata = {
  title: "Safi — Run Your Cleaning Business From One Place",
  description:
    "Bookings, customers, cleaners, payments and WhatsApp communication — all in one platform for Tanzanian cleaning businesses.",
};
